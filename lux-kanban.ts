...
class LuxKanban {
    ...
    render() {
        ...
        for (let b = 0; b < this.boards.length; b++) {
            ...
            for (let i = 0; i < boardItems.length; i++) {
                ...
                dom_board_items_container.appendChild(this.renderBoardItem(boardItem, true));
            }
    ...
    renderBoardItem(boardItem: LuxKanbanBoardItem, addEvents: boolean): HTMLElement {
            ...
            dom_boardItem.addEventListener("mousedown", () => {
                if (this.mouse_is_up) {
                    dom_boardItem_timeout = setTimeout(() => {
                        ...
                        dom_boardItem_ondrag = document.body.appendChild(this.renderBoardItem(boardItem, false));
